...
const stripePromise = loadStripe(
  "pk_test_51PPFvvRwiJcVSJjLvYWfb1Hmuv1ua45PcIc8qh6ZTPDSOMvLUdOQWI8mFXaWu9n9pbw0ZAXmmWPtJdxWeG9P0DsB00dv7Av7lA"
);
...
function Membership({ profileInfo }) {
  ...
  async function updateProfile() {
    const fetchCurrentPlanFromStorage = JSON.parse(
